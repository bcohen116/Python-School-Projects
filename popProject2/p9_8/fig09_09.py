...
class monthlyWorker(Employee):
   def __init__( self, first, last, salary, birthDate, departmentCode):
   ...
   def earnings( self ):
      ...
      if (Date == birthDate):
          ...
          return self.salary
   def __str__( self ):
      """String representation of monthyWorker"""

      return "%17s: %s" % ( "Monthly Worker",
